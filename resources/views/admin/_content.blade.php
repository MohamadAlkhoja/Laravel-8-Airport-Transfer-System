                            ...
                            <div class="ibox-content">
                                ...
                                <div>
                                    <div class="feed-activity-list">
                                        ...
                                        <div class="feed-element">
                                            <a class="float-left" href="profile.html">
                                                <img alt="image" class="rounded-circle" src="{{ asset('assets') }}/admindir/img/a2.jpg">
                                            </a>
                                            <div class="media-body ">
                                        ...
                                        <div class="feed-element">
                                            <a class="float-left" href="profile.html">
                                                <img alt="image" class="rounded-circle" src="{{ asset('assets') }}/admindir/img/a3.jpg">
                                            </a>
                                            <div class="media-body ">
                                                <small class="float-right">2h ago</small>
                                        ...
                                        <div class="feed-element">
                                            <a class="float-left" href="profile.html">
                                                <img alt="image" class="rounded-circle" src="{{ asset('assets') }}/admindir/img/a5.jpg">
                                            </a>
                                            <div class="media-body ">
                                                <small class="float-right">2h ago</small>
